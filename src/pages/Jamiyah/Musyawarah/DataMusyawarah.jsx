...
const DataMusyawarah = () => {
  ...
  useEffect(() => {
    ...
    fetchMusyawarahData(); // ← ini jangan lupa dipanggil
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg">
      <h1 className="text-lg font-bold mb-4">Data Musyawarah</h1>
                ...
                <tr key={item.id_musyawarah} className="hover:bg-gray-100">
                  ...
                  <td className="border p-2 text-center">
                    <div className="flex justify-center gap-2">
                        ...
                        {/* Edit Button */}
                        <Link to={`/musyawarah/edit/${item.id_musyawarah}`}>
