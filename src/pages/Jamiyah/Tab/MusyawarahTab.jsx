        ...
        <table className="table-auto w-full border-collapse border border-gray-300 text-black">
          <thead className="bg-gray-200">
            <tr>
              ...
              <th className="border p-2">Nomor SK</th>  {/* Keeping original headers */}
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td colSpan="7" className="text-center border p-3 sm:p-4 text-red-500">
                  {error}
                </td>
              </tr>
                ...
                return (
                  <tr key={musyawarah.id_musyawarah} className="hover:bg-gray-100">
                    ...
                    <td className="border p-1 sm:p-2 text-center">
                      ...
                      >
                        <span className={`w-1 h-1 sm:w-1.5 sm:h-1.5 mr-1 rounded-full ${
