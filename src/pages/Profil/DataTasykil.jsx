...
const DataTasykil = () => {
  ...
  const fetchTasykil = async () => {
    setLoading(true);
    try {
      const response = await api.get(`/musyawarah/pimpinan-cabang?page=${page}&per_page=${perPage}`);
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Data Tasykil</h1>
        <Link to="/profil/data-tasykil/add-tasykil">
                ...
                <tr key={item.id_musyawarah} className="hover:bg-gray-100">
                  ...
                  <td className="border p-2">
                    <div className="flex justify-center gap-2">
                      <Link to={`/profil/data-tasykil/detail/${item.id_musyawarah}`}>
                      ...
                      <Link to={`/profil/data-tasykil/edit/${item.id_musyawarah}`}>
